...
output_files_path = local_path + "/latex_tables/source_files"

output_latex_tables = local_path + "/latex_tables/tables"
...
for subdir, dirs, files in os.walk(times_input_path):
	...
	for file in files:
		...
		output_file.write("\\"+"begin{tabular}{ | l | l | l | l | c | c | c | r | r | r | r | }\hline\n")
