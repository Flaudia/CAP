...
def main(argv):
    ...
    if not args.conditional_only or args.simple_only:
        ...
        if not os.path.exists(path + "/PDDL/problems/simple/" + d_type + "/" + tag):
            os.makedirs(path + "/PDDL/problems/simple/" + d_type + "/" + tag)
        path += ("/PDDL/problems/simple/" + d_type + "/" + tag)
        ...
        if args.all:
            path = os.path.dirname(os.path.realpath(__file__))
            if not os.path.exists(path + "/PDDL/problems/simple/" + alt_type + "/" + tag):
                os.makedirs(path + "/PDDL/problems/simple/" + alt_type + "/" + tag)
            path += ("/PDDL/problems/simple/" + alt_type + "/" + tag)
    ...
    if not args.simple_only or args.conditional_only:
        ...
        if not os.path.exists(path + "/PDDL/problems/conditional/" + d_type + "/" + tag):
            os.makedirs(path + "/PDDL/problems/conditional/" + d_type + "/" + tag)
        path += ("/PDDL/problems/conditional/" + d_type + "/" + tag)
        ...
        if args.all:
            path = os.path.dirname(os.path.realpath(__file__))
            if not os.path.exists(path + "/PDDL/problems/conditional/" + alt_type + "/" + tag):
                os.makedirs(path + "/PDDL/problems/conditional/" + alt_type + "/" + tag)
            path += ("/PDDL/problems/conditional/" + alt_type + "/" + tag)
