...
(:init
    ...
    (HasAngle angle270 link11)
    (HasAngle angle45 link12)
    (HasAngle angle180 link13)
    (HasAngle angle225 link14)
)
(:goal
(and
    (HasAngle angle180 link1)
    ...
    (HasAngle angle315 link8)
    (HasAngle angle135 link9)
    (HasAngle angle90 link10)
    (HasAngle angle135 link11)
    (HasAngle angle225 link12)
    (HasAngle angle315 link13)
    (HasAngle angle135 link14)
    )
)
)