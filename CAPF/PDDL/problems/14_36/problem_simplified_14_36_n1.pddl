...
(:init
    ...
    (HasAngle angle210 link9)
    (HasAngle angle300 link10)
    (HasAngle angle80 link11)
    (HasAngle angle180 link12)
    (HasAngle angle80 link13)
    (HasAngle angle10 link14)
)
(:goal
(and
    (HasAngle angle50 link1)
    (HasAngle angle290 link2)
    (HasAngle angle20 link3)
    (HasAngle angle50 link4)
    (HasAngle angle140 link5)
    (HasAngle angle0 link6)
    (HasAngle angle250 link7)
    (HasAngle angle120 link8)
    (HasAngle angle200 link9)
    (HasAngle angle340 link10)
    (HasAngle angle50 link11)
    (HasAngle angle100 link12)
    (HasAngle angle90 link13)
    (HasAngle angle220 link14)
    )
)
)