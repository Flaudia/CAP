...
(:init
    ...
    (HasAngle angle70 link1)
    (HasAngle angle180 link2)
    (HasAngle angle230 link3)
    (HasAngle angle250 link4)
    (HasAngle angle70 link5)
    (HasAngle angle30 link6)
    (HasAngle angle230 link7)
    (HasAngle angle210 link8)
    (HasAngle angle120 link9)
    (HasAngle angle120 link10)
    (HasAngle angle340 link11)
    (HasAngle angle190 link12)
    (HasAngle angle190 link13)
    (HasAngle angle70 link14)
)
(:goal
(and
    (HasAngle angle150 link1)
    (HasAngle angle300 link2)
    (HasAngle angle350 link3)
    (HasAngle angle240 link4)
    (HasAngle angle300 link5)
    (HasAngle angle290 link6)
    (HasAngle angle130 link7)
    (HasAngle angle160 link8)
    (HasAngle angle110 link9)
    (HasAngle angle300 link10)
    (HasAngle angle30 link11)
    (HasAngle angle310 link12)
    (HasAngle angle350 link13)
    (HasAngle angle60 link14)
    )
)
)