...
(:init
    ...
    (HasAngle angle10 link5)
    (HasAngle angle270 link6)
    (HasAngle angle110 link7)
    (HasAngle angle160 link8)
    (HasAngle angle40 link9)
    (HasAngle angle280 link10)
    (HasAngle angle320 link11)
    (HasAngle angle40 link12)
    (HasAngle angle50 link13)
    (HasAngle angle270 link14)
)
(:goal
(and
    ...
    (HasAngle angle290 link4)
    (HasAngle angle290 link5)
    (HasAngle angle230 link6)
    (HasAngle angle280 link7)
    (HasAngle angle300 link8)
    (HasAngle angle240 link9)
    (HasAngle angle200 link10)
    (HasAngle angle0 link11)
    (HasAngle angle180 link12)
    (HasAngle angle310 link13)
    (HasAngle angle50 link14)
    )
)
)