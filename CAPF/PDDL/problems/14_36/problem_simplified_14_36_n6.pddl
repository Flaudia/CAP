...
(:init
    ...
    (HasAngle angle10 link3)
    (HasAngle angle160 link4)
    (HasAngle angle230 link5)
    (HasAngle angle350 link6)
    (HasAngle angle250 link7)
    (HasAngle angle330 link8)
    (HasAngle angle220 link9)
    (HasAngle angle290 link10)
    (HasAngle angle240 link11)
    (HasAngle angle350 link12)
    (HasAngle angle180 link13)
    (HasAngle angle80 link14)
)
(:goal
(and
    (HasAngle angle90 link1)
    (HasAngle angle250 link2)
