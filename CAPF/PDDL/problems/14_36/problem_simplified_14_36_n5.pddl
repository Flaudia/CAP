...
(:init
    ...
    (HasAngle angle310 link8)
    (HasAngle angle100 link9)
    (HasAngle angle300 link10)
    (HasAngle angle290 link11)
    (HasAngle angle200 link12)
    (HasAngle angle200 link13)
    (HasAngle angle170 link14)
)
(:goal
(and
